...
Garmin.Controller= function(mainElement, options){}; //just here for jsdoc
Garmin.Controller = Class.create();
Garmin.Controller.prototype = {
    ...
    selectAndUploadAllActivities: function() {
    ...
    * @see Garmin.Controller.cancelFindDevices
    * @see Garmin.Controller.onStartFindDevices
    */
    ...
    * @see Garmin.Controller.onCancelFindDevices
    */
    ...
    * @see Garmin.Controller.startFindDevices
    */
    ...
    */
    onFinishFindDevices: function(json) {
        ...
        if (this.options.afterFinishFindDevices) {
            this.options.afterFinishFindDevices(this, this.devices);
        }
    },
    ...
    * @see Garmin.ControllerDefaultOptions.deviceLabelMaxSize
    * @see Garmin.Device
    */
    ...
    * 
    * @see Garmin.Controller.onFinishUploads
    */
    ...
    * @see Garmin.DeviceControl.FILE_TYPES
    * @see Garmin.ControllerDefaultOptions.afterFinishReadFromDevice
    */
    ...
    * @see Garmin.Controller.onFinishReadFromDevice
    * @event
    */
    ...
    * @see Garmin.DeviceControl
    * @see Garmin.Controller.onStartReadFromDevice
    * @param {JSON} json the progress report in JSON format
    */
        ...
        if (this.factory != null) {
            ...
            switch (this.fileTypeRead) {
                ...
                case Garmin.DeviceControl.FILE_TYPES.tcxDetail:
                    ...
                    //this.activities = this.activities.concat(this.factory.parseDocument(this.readDataDoc));PEW - memoryhawk?
    ...
    * @see Garmin.Controller.afterFinishReadFromDevice
    * @param {JSON} json the progress report in JSON format
    */
    ...
    * @returns {JSON} json object with report values and current Runner instance
    ...
    * @returns {Garmin.Controller} json.display the current Runner instance for UI purposes
    */
    ...
    * @see Garmin.ControllerDefaultOptions.postActivityHandler
    */
    _postActivityToServer: function(dataString) {
        if (this.options.sendDataUrl == null && this.options.postActivityHandler == null) {
            ...
            if (this.options.postActivityHandler != null) {
    ...
    * @event
    * @param {Garmin.Controller} the current Runner instance
    * @see Garmin.ControllerDefaultOptions.afterFinishUploads
    */


    onFinishUploads: function(display) {

        var hideIfDefined = function(hideable) {
            if (hideable) {
                hideable.hide();
            }
        } .bind(this);

        //PEW error here lots of undefined
        if (this.numQueuedActivities > 0) {
            hideIfDefined(this.loadingContentElement);
        }
        ...
        hideIfDefined(this.uploadProgressBar);
        hideIfDefined(this.findDevicesElement);
        //this.readSelectedButton.hide(); TODO PEW
        hideIfDefined(this.deviceBrowserElement);
    ...
    * the default values.
    *
    * @see Garmin.ControllerDefaultOptions for possible options and default values.
    * @throws InvalidOptionException
    * @param Object options - Object with options.
    */
    setOptions: function(options) {
        for (key in options || {}) {
            if (!(key in Garmin.ControllerDefaultOptions)) {
                var err = new Error(key + " is not a valid option name, see Garmin.ControllerDefaultOptions");
                err.name = "InvalidOptionException";
                throw err;
            }
        }
        this.options = Object.extend(Garmin.ControllerDefaultOptions, options || {});
    },
    ...
    */
    ...
    //PEW
    selectAllActivities: function() {
        var checkBoxName = "activityItemCheckbox";
        for (var jj = 0; jj < this.activityDirectory.size(); jj++) {
            var checkBoxElementId = checkBoxName + jj;
            $(checkBoxElementId).checked = true
        }
    },
    ...
    */
    defaultExceptionHandler: function(error) {
        ...
        if (error.name == "BrowserNotSupportedException") {
            ...
            errorStatus = error.message;
            errorStatus += " <a href=\"" + Garmin.Controller.LINKS.pluginDownload + "\" target=\"_blank\">" + this.options.downloadAndInstall + "</a>";
        ...
        if (!this.options.showStatusElement && !hideFromBrowser) {
            if (error.name == "PluginNotInstalledException" || error.name == "OutOfDatePluginException") {
                if (window.confirm(error.message + "\n" + this.options.installNow)) {
                    window.open(Garmin.Controller.LINKS.pluginDownload, "_blank");
                }
            } else {
                alert(errorStatus);
            }
...
/** Constant defining links referenced in the Runner
 * 
 * @struct {public} Garmin.Controller.LINKS
 */
Garmin.Controller.LINKS = {
 ...
 * calling setOptions(optionsHash) on your instance of Garmin.Controller
 * to customize your display options.
 *
 * @class Garmin.ControllerDefaultOptions  
 * @name Garmin.ControllerDefaultOptions 
 */
Garmin.ControllerDefaultOptions =
    {
	...
	*/
	 ...
	 * CSS styling easier.
	 * 
	 * @see Garmin.ControllerDefaultOptions.statusElementId
	 * @see Garmin.ControllerDefaultOptions.readDataElementId
	 * @see Garmin.ControllerDefaultOptions.findDevicesElementId
	 ...
	 * Error Object) and a second arguement for the Runner instance.<br/>
	 * <br/>
	 ...
	 * </p>
	 * @see Garmin.ControllerDefaultOptions.showFindDevicesElement
	 * @type Boolean
	 * @default true
	 */
	 ...
	 * 
	 * @see Garmin.ControllerDefaultOptions.showDeviceButtonsOnFound
	 * @see Garmin.ControllerDefaultOptions.showFindDevicesElement
	 * @type Boolean
	 * @default true 
	 */
	 ...
	 * box will never show.
	 * @default false
	 * @see Garmin.ControllerDefaultOptions.showDeviceSelectNoDevice
	 * @see Garmin.ControllerDefaultOptions.showDeviceSelectOnLoad	  	 
	 * @see Garmin.ControllerDefaultOptions.showFindDevicesElement	 
	 * @type Boolean 
	 */
	 ...
	 * @default true
	 * 
	 * @see Garmin.ControllerDefaultOptions.showDeviceSelectOnSingle
	 * @see Garmin.ControllerDefaultOptions.showDeviceSelectOnLoad	  
	 * @see Garmin.ControllerDefaultOptions.showFindDevicesElement	 
	 * @type Boolean 
	 */	
     ...
     *  display {Garmin.Controller}  - the current instance of the DeveiceDisplay
     ...
     * display {Garmin.Controller - the current instance of the Runner
     * @example
     * function(display) {...}
     * @type function
     * @function
	 ...
	 * @default false
	 * 
	 * @see Garmin.ControllerDefaultOptions.autoFindDevices
	 * @see Garmin.ControllerDefaultOptions.autoWriteData	  
	 * @type Boolean 
	 */					
	autoReadData:				false,
	 ...
	 * @default false
	 *  
	 * @see Garmin.ControllerDefaultOptions.showReadDataElement	 
	 * @type Boolean 
	 */		
	...
	/**DEPRECATED - Use {@link Garmin.ControllerDefaultOptions.readDataTypes} Tells the plug-in what data type to read from the device.  Options for this
	 ...
	 * @see Garmin.ControllerDefaultOptions.showReadDataElement
	 * @see Garmin.DeviceControl.FILE_TYPES
	 * @see Garmin.ControllerDefaultOptions.readDataTypes
	 * @type String 
	 * @deprecated
	 */		
	readDataType:	null,
	 ...
	 * @see Garmin.ControllerDefaultOptions.Garmin.Activity
	 ...
	 * 
	 * @default true
	 * @see Garmin.ControllerDefaultOptions._listTracks
	 * @type Boolean 
	 */		
	 ...
	 * 
	 * @see Garmin.ControllerDefaultOptions.autoFindDevices
	 * @see Garmin.ControllerDefaultOptions.autoReadData
	 * @type Boolean 
	 */					
	autoWriteData:				false,
	 ...
	 * 
	 * @see Garmin.ControllerDefaultOptions.getWriteDataFileName
	 * @type function 
	 ...
	 * @see Garmin.ControllerDefaultOptions.getWriteData
	 * @type function
	 */
	...
	/**DEPRECATED - Use {@link Garmin.ControllerDefaultOptions.writeDataTypes}
	 ...
	 *
	 * @default Garmin.DeviceControl.FILE_TYPES.gpx
	 * @see Garmin.ControllerDefaultOptions.showWriteDataElement
	 * @see Garmin.ControllerDefaultOptions.getWriteData
	 * @see Garmin.ControllerDefaultOptions.getGpiWriteDescription
	 * @see Garmin.ControllerDefaultOptions.writeDataTypes
	 * @type String 
	 * @deprecated
	 */		
	writeDataType:	null,
	 ...
	 * @param {Garmin.Controller} display - the current instance of the display object
	 * @type function
	 * @function
	 ...
	 * @type int
	 * @see Garmin.ControllerDefaultOptions.uploadSelectedActivities
	 */
	uploadMaximum: -1, 
     ...
     *  <br/>display {GarminController} - the display object
	 ...
	 *
	 * @see Garmin.ControllerDefaultOptions.sendDataUrl
	 * @see Garmin.ControllerDefaultOptions.getSendOptions
	 ...
	 * @see Garmin.ControllerDefaultOptions.previewDeviceDefaultImg
	 * @type String 
	 */
	 ...
	 * @see Garmin.ControllerDefaultOptions.previewDeviceId
	 * @see Garmin.ControllerDefaultOptions.useDeviceSelectList
	 * @type String 
	 */
	...
	/** DEPRECATED Column header for the Date fields in the activity directory.  Useful for CSS customizations and internationalization.  @type String @deprecated @see Garmin.ControllerDefaultOptions.getActivityDirectoryHeaderIdLabel */
...
var GarminController = {
	...
	load: function() {
		if((typeof Prototype=='undefined') || 
			...
			throw("GarminController requires the Prototype JavaScript framework >= 1.5.0");
		}

		$A(document.getElementsByTagName("script"))
		.findAll(
			function(s) {
				return (s.src && s.src.match(/GarminController\.js(\?.*)?$/))
			}
		)
		.each(
			function(s) {
				var path = s.src.replace(/GarminController\.js(\?.*)?$/,'../../');
			    ...
			    (includes ? includes[1] : dependencies).split(',').each(
					function(include) {
						GarminController.require(path+include+'.js') 
					}
				);
			}
		);
